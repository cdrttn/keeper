...
// FUNC extensions, set instruction table
#define LCD_FUNC_EXT_IS		0b00000011
#define LCD_FUNC_8BIT_2LN_IS(t)	(LCD_FUNC | LCD_FUNC_8BIT | LCD_FUNC_2LN | ((t) & LCD_FUNC_EXT_IS))
#define LCD_FUNC_8BIT_1LN_IS(t)	(LCD_FUNC | LCD_FUNC_8BIT | ((t) & LCD_FUNC_EXT_IS))
#define LCD_FUNC_8BIT_1LN_5X10_IS(t)	(LCD_FUNC_8BIT_1LN | LCD_FUNC_5X10 | ((t) & LCD_FUNC_EXT_IS))
...
#define LCD_IS1_BIAS_14B_3LN	(LCD_IS1_BIAS_SET | LCD_IS1_BIAS_BS | LCD_IS1_BIAS_FX)
#define LCD_IS1_BIAS_15B_3LN	(LCD_IS1_BIAS_SET | LCD_IS1_BIAS_FX)
...
#define LCD_IS1_FOLLOWER_ON(c)	(LCD_IS1_FC | ((c) & LCD_IS1_FC_R20))

#define LCD_IS1_SET_CONTRAST_		0b01110000
#define LCD_IS1_SET_CONTRAST_MASK	0b00001111
#define LCD_IS1_SET_CONTRAST(a) (LCD_IS1_SET_CONTRAST_ | ((a) & LCD_IS1_SET_CONTRAST_MASK))
